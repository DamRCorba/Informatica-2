...
- Diagrama de máquina de estado y memoria descriptiva: __Fecha de entrega 26 al 30 de Agosto__
> La memoria descriptiva, es la explicación textual y teórica del funcionamiento del sistema.

- Primer versión de código: __Fecha de entrega de 7 al 11 de Octubre__
